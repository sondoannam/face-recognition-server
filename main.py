...
from ws import websocket_register, websocket_detect
import os
import cv2
import numpy as np
import io
...
@app.get("/")
async def root():
    return {"message": "Face Recognition API Server", "version": "1.0.0"}
...
# Add WebSocket endpoint for detection
app.add_api_websocket_route("/ws/detect", websocket_detect)
